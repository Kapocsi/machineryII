 ...
 */
__EXTERN void *memccpy __PROTO((void *dst, const void *src, int ucharstop,
                                size_t size));
...
__EXTERN void _bcopy __PROTO((const void *src, void *dst,
                              unsigned long length));
__EXTERN int _bcmp __PROTO((const void *s1, const void *s2,
                            unsigned long length));
...
static __inline__ char *__strcat(char *dst, const char *src) {
...
static __inline__ char *__strcpy(char *dst, const char *src) {
...
static __inline__ size_t __strlen(const char *scan) {
