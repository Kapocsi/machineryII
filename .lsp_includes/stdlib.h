...
#define MB_CUR_MAX                                                             \
    1 /* max. length of multibyte character                                    \
         in current locale */
...
__EXTERN unsigned long int strtoul __PROTO((const char *nptr, char **endptr,
                                            int base));
...
__EXTERN void *bsearch __PROTO((const void *key, const void *base, size_t num,
                                size_t size,
                                int (*cmp)(const void *, const void *)));
__EXTERN void qsort __PROTO((void *base, size_t total_elems, size_t size,
                             int (*cmp)(const void *, const void *)));
