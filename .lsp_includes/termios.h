...
__EXTERN int cfsetispeed __PROTO((struct termios * stp, speed_t baudcode));
__EXTERN int cfsetospeed __PROTO((struct termios * stp, speed_t baudcode));
...
__EXTERN int tcsetattr __PROTO((int fd, int action, const struct termios *stp));
